...
%
%      BICYCLEDAQ('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in BICYCLEDAQ.M with the given input arguments.
%
%      BICYCLEDAQ('Property','Value',...) creates a new BICYCLEDAQ or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before BicycleDAQ_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to BicycleDAQ_OpeningFcn via varargin.
%
...
% Last Modified by GUIDE v2.5 10-Nov-2010 21:06:45
...
% varargin   command line arguments to BicycleDAQ (see VARARGIN)
